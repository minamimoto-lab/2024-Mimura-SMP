...
def learn( savedir, dim, gamma, eta, initial_class, avelen, maxlen, minlen, skiplen ):
    ...
    files =  [ "data/data_for_SMP-marmofeed/marmofeed_%03d.txt" % j for j in range(51) ]
...
def recog( modeldir, savedir, dim, gamma, eta, initial_class, avelen, maxlen, minlen, skiplen ):
    ...
    gpsegm.load_data( [ "data/data_for_SMP-marmofeed/marmofeed_%03d.txt" % j for j in range(51) ] )
...
#    nums = range(10, 31, 5)
    ...
    #parameters
      ...
      # CHECK: GaussianProcess.pyx L38-42
      beta = 10.0
      theta0 = 0
      theta1 = 0
      theta2 = 1
